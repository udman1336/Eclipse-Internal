...
static_assert(offsetof(UAthenaPlayerLevel_C, TotalContentSlot) == 0x000258, "Member 'UAthenaPlayerLevel_C::TotalContentSlot' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, XpBar) == 0x000260, "Member 'UAthenaPlayerLevel_C::XpBar' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, XPNeeded) == 0x000268, "Member 'UAthenaPlayerLevel_C::XPNeeded' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, XPOwned) == 0x000270, "Member 'UAthenaPlayerLevel_C::XPOwned' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, Animating) == 0x000278, "Member 'UAthenaPlayerLevel_C::Animating' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, CurrentXP) == 0x00027C, "Member 'UAthenaPlayerLevel_C::CurrentXP' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, TargetXp) == 0x000280, "Member 'UAthenaPlayerLevel_C::TargetXp' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, WrapAroundXp) == 0x000284, "Member 'UAthenaPlayerLevel_C::WrapAroundXp' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, XpToAdd) == 0x000288, "Member 'UAthenaPlayerLevel_C::XpToAdd' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, XpLerp) == 0x00028C, "Member 'UAthenaPlayerLevel_C::XpLerp' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, CurrentLevel) == 0x000290, "Member 'UAthenaPlayerLevel_C::CurrentLevel' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, MaxLevel) == 0x000294, "Member 'UAthenaPlayerLevel_C::MaxLevel' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, LevelXpForLevel) == 0x000298, "Member 'UAthenaPlayerLevel_C::LevelXpForLevel' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerLevel_C, LevelChanged) == 0x0002A0, "Member 'UAthenaPlayerLevel_C::LevelChanged' has a wrong offset!");
