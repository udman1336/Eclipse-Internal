...
static_assert(sizeof(Results_StatsSubtypeBox_C_InitializeScoreType) == 0x0003D0, "Wrong size on Results_StatsSubtypeBox_C_InitializeScoreType");
...
static_assert(offsetof(Results_StatsSubtypeBox_C_InitializeScoreType, CallFunc_GetScoreStylingData_ReturnValue) == 0x000398, "Member 'Results_StatsSubtypeBox_C_InitializeScoreType::CallFunc_GetScoreStylingData_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_StatsSubtypeBox_C_InitializeScoreType, K2Node_MakeStruct_SlateColor) == 0x0003A0, "Member 'Results_StatsSubtypeBox_C_InitializeScoreType::K2Node_MakeStruct_SlateColor' has a wrong offset!");
static_assert(offsetof(Results_StatsSubtypeBox_C_InitializeScoreType, K2Node_SwitchEnum_CmpSuccess) == 0x0003C8, "Member 'Results_StatsSubtypeBox_C_InitializeScoreType::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
