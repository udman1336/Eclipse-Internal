...
static_assert(offsetof(DayWidget_C_Update, CallFunc_IsValid_ReturnValue1) == 0x000018, "Member 'DayWidget_C_Update::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
