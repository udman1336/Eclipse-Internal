...
static_assert(sizeof(AAnnounce_NameHomeBase_C) == 0x000558, "Wrong size on AAnnounce_NameHomeBase_C");
static_assert(offsetof(AAnnounce_NameHomeBase_C, UberGraphFrame_Announce_NameHomeBase_C) == 0x000550, "Member 'AAnnounce_NameHomeBase_C::UberGraphFrame_Announce_NameHomeBase_C' has a wrong offset!");
