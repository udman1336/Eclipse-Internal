...
static_assert(offsetof(ZoneDayCompletion_ScoreBlock_C_Increment, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x00001C, "Member 'ZoneDayCompletion_ScoreBlock_C_Increment::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
