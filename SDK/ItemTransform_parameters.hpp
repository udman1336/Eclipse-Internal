...
static_assert(sizeof(ItemTransform_C_ExecuteUbergraph_ItemTransform) == 0x000090, "Wrong size on ItemTransform_C_ExecuteUbergraph_ItemTransform");
...
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, K2Node_ComponentBoundEvent_ActiveWidget) == 0x000020, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::K2Node_ComponentBoundEvent_ActiveWidget' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, K2Node_ComponentBoundEvent_ActiveWidgetIndex) == 0x000028, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::K2Node_ComponentBoundEvent_ActiveWidgetIndex' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_HandleSelect_PassThrough) == 0x00002C, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_HandleSelect_PassThrough' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, K2Node_ComponentBoundEvent_TransformActive) == 0x00002D, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::K2Node_ComponentBoundEvent_TransformActive' has a wrong offset!");
...
static_assert(sizeof(ItemTransform_C_OpenConfirmation) == 0x000060, "Wrong size on ItemTransform_C_OpenConfirmation");
...
static_assert(offsetof(ItemTransform_C_OpenConfirmation, CallFunc_Get_Transform_Data_SelectedKey) == 0x000030, "Member 'ItemTransform_C_OpenConfirmation::CallFunc_Get_Transform_Data_SelectedKey' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_OpenConfirmation, CallFunc_Get_Transform_Data_SacrificeItems) == 0x000038, "Member 'ItemTransform_C_OpenConfirmation::CallFunc_Get_Transform_Data_SacrificeItems' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_OpenConfirmation, CallFunc_Get_Transform_Data_CurrentSacrificePoints) == 0x000048, "Member 'ItemTransform_C_OpenConfirmation::CallFunc_Get_Transform_Data_CurrentSacrificePoints' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_OpenConfirmation, CallFunc_Get_Transform_Data_CurrentTier) == 0x00004C, "Member 'ItemTransform_C_OpenConfirmation::CallFunc_Get_Transform_Data_CurrentTier' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_OpenConfirmation, CallFunc_IsValid_ReturnValue) == 0x000050, "Member 'ItemTransform_C_OpenConfirmation::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_OpenConfirmation, CallFunc_GetUIManagerWidget_ReturnValue) == 0x000058, "Member 'ItemTransform_C_OpenConfirmation::CallFunc_GetUIManagerWidget_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(ItemTransform_C_HandleTransformConfirm) == 0x000040, "Wrong size on ItemTransform_C_HandleTransformConfirm");
...
static_assert(offsetof(ItemTransform_C_HandleTransformConfirm, CallFunc_Get_Transform_Data_SelectedKey) == 0x000008, "Member 'ItemTransform_C_HandleTransformConfirm::CallFunc_Get_Transform_Data_SelectedKey' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_HandleTransformConfirm, CallFunc_Get_Transform_Data_SacrificeItems) == 0x000010, "Member 'ItemTransform_C_HandleTransformConfirm::CallFunc_Get_Transform_Data_SacrificeItems' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_HandleTransformConfirm, CallFunc_Get_Transform_Data_CurrentSacrificePoints) == 0x000020, "Member 'ItemTransform_C_HandleTransformConfirm::CallFunc_Get_Transform_Data_CurrentSacrificePoints' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_HandleTransformConfirm, CallFunc_Get_Transform_Data_CurrentTier) == 0x000024, "Member 'ItemTransform_C_HandleTransformConfirm::CallFunc_Get_Transform_Data_CurrentTier' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_HandleTransformConfirm, CallFunc_GetItemDefinitionBP_ReturnValue) == 0x000028, "Member 'ItemTransform_C_HandleTransformConfirm::CallFunc_GetItemDefinitionBP_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_HandleTransformConfirm, K2Node_DynamicCast_AsFort_Conversion_Control_Item_Definition) == 0x000030, "Member 'ItemTransform_C_HandleTransformConfirm::K2Node_DynamicCast_AsFort_Conversion_Control_Item_Definition' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_HandleTransformConfirm, K2Node_DynamicCast_bSuccess) == 0x000038, "Member 'ItemTransform_C_HandleTransformConfirm::K2Node_DynamicCast_bSuccess' has a wrong offset!");
...
static_assert(alignof(ItemTransform_C_HandleTransformAction) == 0x000001, "Wrong alignment on ItemTransform_C_HandleTransformAction");
static_assert(sizeof(ItemTransform_C_HandleTransformAction) == 0x000001, "Wrong size on ItemTransform_C_HandleTransformAction");
...
static_assert(alignof(ItemTransform_C_Handle_Key_Screen_Activated) == 0x000008, "Wrong alignment on ItemTransform_C_Handle_Key_Screen_Activated");
static_assert(sizeof(ItemTransform_C_Handle_Key_Screen_Activated) == 0x000010, "Wrong size on ItemTransform_C_Handle_Key_Screen_Activated");
static_assert(offsetof(ItemTransform_C_Handle_Key_Screen_Activated, CallFunc_Get_Selected_Item_SelectedKey) == 0x000000, "Member 'ItemTransform_C_Handle_Key_Screen_Activated::CallFunc_Get_Selected_Item_SelectedKey' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_Handle_Key_Screen_Activated, CallFunc_IsValid_ReturnValue) == 0x000008, "Member 'ItemTransform_C_Handle_Key_Screen_Activated::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(alignof(ItemTransform_C_Handle_Slot_Screen_Activated) == 0x000008, "Wrong alignment on ItemTransform_C_Handle_Slot_Screen_Activated");
static_assert(sizeof(ItemTransform_C_Handle_Slot_Screen_Activated) == 0x000008, "Wrong size on ItemTransform_C_Handle_Slot_Screen_Activated");
static_assert(offsetof(ItemTransform_C_Handle_Slot_Screen_Activated, CallFunc_Get_Selected_Item_SelectedKey) == 0x000000, "Member 'ItemTransform_C_Handle_Slot_Screen_Activated::CallFunc_Get_Selected_Item_SelectedKey' has a wrong offset!");
...
static_assert(alignof(ItemTransform_C_Handle_SubScreen_Activated) == 0x000004, "Wrong alignment on ItemTransform_C_Handle_SubScreen_Activated");
static_assert(sizeof(ItemTransform_C_Handle_SubScreen_Activated) == 0x000008, "Wrong size on ItemTransform_C_Handle_SubScreen_Activated");
static_assert(offsetof(ItemTransform_C_Handle_SubScreen_Activated, CallFunc_GetActiveWidgetIndex_ReturnValue) == 0x000000, "Member 'ItemTransform_C_Handle_SubScreen_Activated::CallFunc_GetActiveWidgetIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_Handle_SubScreen_Activated, K2Node_SwitchInteger_CmpSuccess) == 0x000004, "Member 'ItemTransform_C_Handle_SubScreen_Activated::K2Node_SwitchInteger_CmpSuccess' has a wrong offset!");
...
static_assert(alignof(ItemTransform_C_SetAndLogSelectedKey) == 0x000008, "Wrong alignment on ItemTransform_C_SetAndLogSelectedKey");
static_assert(sizeof(ItemTransform_C_SetAndLogSelectedKey) == 0x000008, "Wrong size on ItemTransform_C_SetAndLogSelectedKey");
static_assert(offsetof(ItemTransform_C_SetAndLogSelectedKey, SelectedItem) == 0x000000, "Member 'ItemTransform_C_SetAndLogSelectedKey::SelectedItem' has a wrong offset!");
