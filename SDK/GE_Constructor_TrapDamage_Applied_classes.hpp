...
static_assert(alignof(UGE_Constructor_TrapDamage_Applied_C) == 0x000010, "Wrong alignment on UGE_Constructor_TrapDamage_Applied_C");
static_assert(sizeof(UGE_Constructor_TrapDamage_Applied_C) == 0x000670, "Wrong size on UGE_Constructor_TrapDamage_Applied_C");
