...
static_assert(offsetof(AnimNotifyState_DisableSteering_C_Received_NotifyBegin, K2Node_DynamicCast_bSuccess1) == 0x000040, "Member 'AnimNotifyState_DisableSteering_C_Received_NotifyBegin::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
...
static_assert(offsetof(AnimNotifyState_DisableSteering_C_Received_NotifyEnd, K2Node_DynamicCast_bSuccess1) == 0x000040, "Member 'AnimNotifyState_DisableSteering_C_Received_NotifyEnd::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
