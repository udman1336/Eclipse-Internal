...
static_assert(sizeof(Rewards_Header_C_FadeInSubHeader) == 0x000018, "Wrong size on Rewards_Header_C_FadeInSubHeader");
...
static_assert(offsetof(Rewards_Header_C_FadeInSubHeader, CallFunc_BooleanAND_ReturnValue) == 0x000014, "Member 'Rewards_Header_C_FadeInSubHeader::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeStruct_FormatArgumentData1) == 0x000068, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeArray_Array) == 0x0000A8, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeArray_Array1) == 0x0000B8, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeArray_Array1' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, CallFunc_Format_ReturnValue) == 0x0000C8, "Member 'Rewards_Header_C_PopulateFromRewardType::CallFunc_Format_ReturnValue' has a wrong offset!");
