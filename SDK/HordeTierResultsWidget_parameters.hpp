...
static_assert(offsetof(HordeTierResultsWidget_C_ChooseMediaToUse, K2Node_Select12_Default) == 0x0003C8, "Member 'HordeTierResultsWidget_C_ChooseMediaToUse::K2Node_Select12_Default' has a wrong offset!");
