...
static_assert(offsetof(URadialPickerItem_C, PickerItem) == 0x000248, "Member 'URadialPickerItem_C::PickerItem' has a wrong offset!");
static_assert(offsetof(URadialPickerItem_C, TextLabel) == 0x000250, "Member 'URadialPickerItem_C::TextLabel' has a wrong offset!");
static_assert(offsetof(URadialPickerItem_C, PickerItemText) == 0x000258, "Member 'URadialPickerItem_C::PickerItemText' has a wrong offset!");
static_assert(offsetof(URadialPickerItem_C, On_Item_Touched) == 0x000270, "Member 'URadialPickerItem_C::On_Item_Touched' has a wrong offset!");
