...
static_assert(sizeof(VaultWeaponPlacementHelper_C_OnTeamMemberAdded) == 0x000200, "Wrong size on VaultWeaponPlacementHelper_C_OnTeamMemberAdded");
...
static_assert(offsetof(VaultWeaponPlacementHelper_C_OnTeamMemberAdded, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x0001F8, "Member 'VaultWeaponPlacementHelper_C_OnTeamMemberAdded::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(VaultWeaponPlacementHelper_C_OnTeamMemberStateChanged) == 0x000200, "Wrong size on VaultWeaponPlacementHelper_C_OnTeamMemberStateChanged");
...
static_assert(offsetof(VaultWeaponPlacementHelper_C_OnTeamMemberStateChanged, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x0001F8, "Member 'VaultWeaponPlacementHelper_C_OnTeamMemberStateChanged::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
