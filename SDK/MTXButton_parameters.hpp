...
static_assert(offsetof(MTXButton_C_UpdateState, CallFunc_GetCurrentInputType_ReturnValue) == 0x000021, "Member 'MTXButton_C_UpdateState::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");
static_assert(offsetof(MTXButton_C_UpdateState, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000022, "Member 'MTXButton_C_UpdateState::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(MTXButton_C_UpdateState, K2Node_Select_Default) == 0x000023, "Member 'MTXButton_C_UpdateState::K2Node_Select_Default' has a wrong offset!");
