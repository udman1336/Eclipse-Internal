...
static_assert(sizeof(UItemDetailsHeaderTagListText_C) == 0x000270, "Wrong size on UItemDetailsHeaderTagListText_C");
static_assert(offsetof(UItemDetailsHeaderTagListText_C, UberGraphFrame) == 0x000260, "Member 'UItemDetailsHeaderTagListText_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemDetailsHeaderTagListText_C, TagListTextBlock) == 0x000268, "Member 'UItemDetailsHeaderTagListText_C::TagListTextBlock' has a wrong offset!");
