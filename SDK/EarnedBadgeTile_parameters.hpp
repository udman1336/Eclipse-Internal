...
static_assert(offsetof(EarnedBadgeTile_C_ExecuteUbergraph_EarnedBadgeTile, Temp_byte_Variable1) == 0x000006, "Member 'EarnedBadgeTile_C_ExecuteUbergraph_EarnedBadgeTile::Temp_byte_Variable1' has a wrong offset!");
