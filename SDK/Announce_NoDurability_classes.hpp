...
static_assert(sizeof(AAnnounce_NoDurability_C) == 0x000480, "Wrong size on AAnnounce_NoDurability_C");
static_assert(offsetof(AAnnounce_NoDurability_C, UberGraphFrame) == 0x000470, "Member 'AAnnounce_NoDurability_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAnnounce_NoDurability_C, DefaultSceneRoot) == 0x000478, "Member 'AAnnounce_NoDurability_C::DefaultSceneRoot' has a wrong offset!");
