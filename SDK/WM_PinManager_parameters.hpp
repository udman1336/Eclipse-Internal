...
static_assert(sizeof(WM_PinManager_C_CreateWorldMapPin) == 0x0005A0, "Wrong size on WM_PinManager_C_CreateWorldMapPin");
...
static_assert(offsetof(WM_PinManager_C_CreateWorldMapPin, CallFunc_GetTheaterData_ReturnValue) == 0x000588, "Member 'WM_PinManager_C_CreateWorldMapPin::CallFunc_GetTheaterData_ReturnValue' has a wrong offset!");
static_assert(offsetof(WM_PinManager_C_CreateWorldMapPin, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x000590, "Member 'WM_PinManager_C_CreateWorldMapPin::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(WM_PinManager_C_CreateWorldMapPin, CallFunc_FinishSpawningActor_ReturnValue) == 0x000598, "Member 'WM_PinManager_C_CreateWorldMapPin::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
