...
static_assert(sizeof(UNetDebugUI_C) == 0x000330, "Wrong size on UNetDebugUI_C");
static_assert(offsetof(UNetDebugUI_C, Image_1) == 0x000318, "Member 'UNetDebugUI_C::Image_1' has a wrong offset!");
static_assert(offsetof(UNetDebugUI_C, Image_2) == 0x000320, "Member 'UNetDebugUI_C::Image_2' has a wrong offset!");
static_assert(offsetof(UNetDebugUI_C, TimeoutIcon) == 0x000328, "Member 'UNetDebugUI_C::TimeoutIcon' has a wrong offset!");
