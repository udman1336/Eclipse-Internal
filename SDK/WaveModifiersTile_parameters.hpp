...
static_assert(sizeof(WaveModifiersTile_C_ExecuteUbergraph_WaveModifiersTile) == 0x0000D8, "Wrong size on WaveModifiersTile_C_ExecuteUbergraph_WaveModifiersTile");
...
static_assert(offsetof(WaveModifiersTile_C_ExecuteUbergraph_WaveModifiersTile, CallFunc_GetDescription_ReturnValue) == 0x0000A8, "Member 'WaveModifiersTile_C_ExecuteUbergraph_WaveModifiersTile::CallFunc_GetDescription_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaveModifiersTile_C_ExecuteUbergraph_WaveModifiersTile, CallFunc_GetDisplayName_ReturnValue) == 0x0000C0, "Member 'WaveModifiersTile_C_ExecuteUbergraph_WaveModifiersTile::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WaveModifiersTile_C_SetModifierItem) == 0x0000C8, "Wrong size on WaveModifiersTile_C_SetModifierItem");
...
static_assert(offsetof(WaveModifiersTile_C_SetModifierItem, CallFunc_GetDescription_ReturnValue) == 0x000098, "Member 'WaveModifiersTile_C_SetModifierItem::CallFunc_GetDescription_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaveModifiersTile_C_SetModifierItem, CallFunc_GetDisplayName_ReturnValue) == 0x0000B0, "Member 'WaveModifiersTile_C_SetModifierItem::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
