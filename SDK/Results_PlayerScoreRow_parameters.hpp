...
static_assert(sizeof(Results_PlayerScoreRow_C_InitializePlayerName) == 0x000040, "Wrong size on Results_PlayerScoreRow_C_InitializePlayerName");
...
static_assert(offsetof(Results_PlayerScoreRow_C_InitializePlayerName, CallFunc_GetPlayerPlatform_ReturnValue) == 0x000010, "Member 'Results_PlayerScoreRow_C_InitializePlayerName::CallFunc_GetPlayerPlatform_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreRow_C_InitializePlayerName, CallFunc_GetPlayerName_ReturnValue) == 0x000020, "Member 'Results_PlayerScoreRow_C_InitializePlayerName::CallFunc_GetPlayerName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreRow_C_InitializePlayerName, CallFunc_GetContext_ReturnValue) == 0x000038, "Member 'Results_PlayerScoreRow_C_InitializePlayerName::CallFunc_GetContext_ReturnValue' has a wrong offset!");
