...
static_assert(sizeof(UThirdPartyTab_C) == 0x000228, "Wrong size on UThirdPartyTab_C");
static_assert(offsetof(UThirdPartyTab_C, FortRichTextBlock_0) == 0x000218, "Member 'UThirdPartyTab_C::FortRichTextBlock_0' has a wrong offset!");
static_assert(offsetof(UThirdPartyTab_C, ScrollBox_2) == 0x000220, "Member 'UThirdPartyTab_C::ScrollBox_2' has a wrong offset!");
