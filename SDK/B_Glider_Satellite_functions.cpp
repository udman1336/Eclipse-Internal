...
#include "B_Glider_Satellite_classes.hpp"
#include "B_Glider_Satellite_parameters.hpp"
...
void AB_Glider_Satellite_C::ExecuteUbergraph_B_Glider_Satellite(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_Satellite_C", "ExecuteUbergraph_B_Glider_Satellite");

	Params::B_Glider_Satellite_C_ExecuteUbergraph_B_Glider_Satellite Parms{};
...
void AB_Glider_Satellite_C::OnParachuteTrailUpdated(float MovementLengthSquared, float ForwardDot, float RightDot, float RotationalMovementAcceleration)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_Satellite_C", "OnParachuteTrailUpdated");

	Params::B_Glider_Satellite_C_OnParachuteTrailUpdated Parms{};
...
void AB_Glider_Satellite_C::ReceiveBeginPlay()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_Satellite_C", "ReceiveBeginPlay");
...
void AB_Glider_Satellite_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_Satellite_C", "UserConstructionScript");
