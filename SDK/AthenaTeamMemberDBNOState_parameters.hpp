...
static_assert(sizeof(AthenaTeamMemberDBNOState_C_ExecuteUbergraph_AthenaTeamMemberDBNOState) == 0x000004, "Wrong size on AthenaTeamMemberDBNOState_C_ExecuteUbergraph_AthenaTeamMemberDBNOState");
