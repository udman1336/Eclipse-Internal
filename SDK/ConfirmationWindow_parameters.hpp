...
static_assert(sizeof(ConfirmationWindow_C_TapToClose) == 0x000218, "Wrong size on ConfirmationWindow_C_TapToClose");
...
static_assert(offsetof(ConfirmationWindow_C_TapToClose, CallFunc_Handled_ReturnValue) == 0x000160, "Member 'ConfirmationWindow_C_TapToClose::CallFunc_Handled_ReturnValue' has a wrong offset!");
