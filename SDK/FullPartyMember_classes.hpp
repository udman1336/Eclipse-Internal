...
static_assert(offsetof(UFullPartyMember_C, PlayerBanner_118) == 0x0002C0, "Member 'UFullPartyMember_C::PlayerBanner_118' has a wrong offset!");
...
static_assert(offsetof(UFullPartyMember_C, PowerWidget) == 0x0002D8, "Member 'UFullPartyMember_C::PowerWidget' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, ResistanceDisplay) == 0x0002E0, "Member 'UFullPartyMember_C::ResistanceDisplay' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, SecondaryFortitudeDisplay) == 0x0002E8, "Member 'UFullPartyMember_C::SecondaryFortitudeDisplay' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, SecondaryOffenseDisplay) == 0x0002F0, "Member 'UFullPartyMember_C::SecondaryOffenseDisplay' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, SecondaryResistanceDisplay) == 0x0002F8, "Member 'UFullPartyMember_C::SecondaryResistanceDisplay' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, SecondaryTechDisplay) == 0x000300, "Member 'UFullPartyMember_C::SecondaryTechDisplay' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, TechDisplay) == 0x000308, "Member 'UFullPartyMember_C::TechDisplay' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, MemberInfo) == 0x000310, "Member 'UFullPartyMember_C::MemberInfo' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, Dimensions) == 0x000508, "Member 'UFullPartyMember_C::Dimensions' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, DeclineAction) == 0x000510, "Member 'UFullPartyMember_C::DeclineAction' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, LocalPlayerActionsTitle) == 0x000518, "Member 'UFullPartyMember_C::LocalPlayerActionsTitle' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, bLocalPlayerAlone) == 0x000530, "Member 'UFullPartyMember_C::bLocalPlayerAlone' has a wrong offset!");
static_assert(offsetof(UFullPartyMember_C, NewLocalPlayerWidget) == 0x000538, "Member 'UFullPartyMember_C::NewLocalPlayerWidget' has a wrong offset!");
