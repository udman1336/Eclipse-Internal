...
static_assert(sizeof(UActiveModifierItemHUD_C) == 0x000220, "Wrong size on UActiveModifierItemHUD_C");
static_assert(offsetof(UActiveModifierItemHUD_C, ImageModifier) == 0x000218, "Member 'UActiveModifierItemHUD_C::ImageModifier' has a wrong offset!");
