...
static_assert(sizeof(QuestInfo_BulletList_C_AddEntryWithBrush) == 0x0000C0, "Wrong size on QuestInfo_BulletList_C_AddEntryWithBrush");
...
static_assert(offsetof(QuestInfo_BulletList_C_AddEntryWithBrush, NewEntry) == 0x0000A0, "Member 'QuestInfo_BulletList_C_AddEntryWithBrush::NewEntry' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletList_C_AddEntryWithBrush, CallFunc_Create_ReturnValue) == 0x0000A8, "Member 'QuestInfo_BulletList_C_AddEntryWithBrush::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletList_C_AddEntryWithBrush, CallFunc_GetChildrenCount_ReturnValue) == 0x0000B0, "Member 'QuestInfo_BulletList_C_AddEntryWithBrush::CallFunc_GetChildrenCount_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletList_C_AddEntryWithBrush, CallFunc_Greater_IntInt_ReturnValue) == 0x0000B4, "Member 'QuestInfo_BulletList_C_AddEntryWithBrush::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletList_C_AddEntryWithBrush, CallFunc_AddChild_ReturnValue) == 0x0000B8, "Member 'QuestInfo_BulletList_C_AddEntryWithBrush::CallFunc_AddChild_ReturnValue' has a wrong offset!");
