...
static_assert(offsetof(UMainMenu_C, HelpButton) == 0x0002A0, "Member 'UMainMenu_C::HelpButton' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, Image_1) == 0x0002A8, "Member 'UMainMenu_C::Image_1' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, Image_2) == 0x0002B0, "Member 'UMainMenu_C::Image_2' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, Image_3) == 0x0002B8, "Member 'UMainMenu_C::Image_3' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, Image_4) == 0x0002C0, "Member 'UMainMenu_C::Image_4' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, Image_5) == 0x0002C8, "Member 'UMainMenu_C::Image_5' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, Image_6) == 0x0002D0, "Member 'UMainMenu_C::Image_6' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, Image_8) == 0x0002D8, "Member 'UMainMenu_C::Image_8' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, ImagePartyInvite) == 0x0002E0, "Member 'UMainMenu_C::ImagePartyInvite' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, InviteCodesButton) == 0x0002E8, "Member 'UMainMenu_C::InviteCodesButton' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, InviteCodesCountText) == 0x0002F0, "Member 'UMainMenu_C::InviteCodesCountText' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, LeaveButton) == 0x0002F8, "Member 'UMainMenu_C::LeaveButton' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, Legal) == 0x000300, "Member 'UMainMenu_C::Legal' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, LogoutButton) == 0x000308, "Member 'UMainMenu_C::LogoutButton' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, MessagesButton) == 0x000310, "Member 'UMainMenu_C::MessagesButton' has a wrong offset!");
