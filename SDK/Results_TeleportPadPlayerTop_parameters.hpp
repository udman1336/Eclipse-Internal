...
static_assert(offsetof(Results_TeleportPadPlayerTop_C_Initialize, CallFunc_GetPlayerPlatform_ReturnValue) == 0x000040, "Member 'Results_TeleportPadPlayerTop_C_Initialize::CallFunc_GetPlayerPlatform_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPadPlayerTop_C_Initialize, CallFunc_GetPlayerName_ReturnValue) == 0x000050, "Member 'Results_TeleportPadPlayerTop_C_Initialize::CallFunc_GetPlayerName_ReturnValue' has a wrong offset!");
