...
static_assert(alignof(IBPI_ShieldFlash_C) == 0x000008, "Wrong alignment on IBPI_ShieldFlash_C");
static_assert(sizeof(IBPI_ShieldFlash_C) == 0x000028, "Wrong size on IBPI_ShieldFlash_C");
