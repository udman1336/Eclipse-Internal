...
#include "B_Glider_SpaceShuttleB_classes.hpp"
#include "B_Glider_SpaceShuttleB_parameters.hpp"
...
void AB_Glider_SpaceShuttleB_C::ExecuteUbergraph_B_Glider_SpaceShuttleB(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_SpaceShuttleB_C", "ExecuteUbergraph_B_Glider_SpaceShuttleB");

	Params::B_Glider_SpaceShuttleB_C_ExecuteUbergraph_B_Glider_SpaceShuttleB Parms{};
...
void AB_Glider_SpaceShuttleB_C::ReceiveEndPlay(EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_SpaceShuttleB_C", "ReceiveEndPlay");

	Params::B_Glider_SpaceShuttleB_C_ReceiveEndPlay Parms{};
...
void AB_Glider_SpaceShuttleB_C::OnParachuteTrailUpdated(float MovementLengthSquared, float ForwardDot, float RightDot, float RotationalMovementAcceleration)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_SpaceShuttleB_C", "OnParachuteTrailUpdated");

	Params::B_Glider_SpaceShuttleB_C_OnParachuteTrailUpdated Parms{};
...
void AB_Glider_SpaceShuttleB_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_SpaceShuttleB_C", "UserConstructionScript");
