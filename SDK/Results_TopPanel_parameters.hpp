...
static_assert(sizeof(Results_TopPanel_C_Initialize) == 0x0004C8, "Wrong size on Results_TopPanel_C_Initialize");
...
static_assert(offsetof(Results_TopPanel_C_Initialize, K2Node_MakeStruct_FormatArgumentData) == 0x000400, "Member 'Results_TopPanel_C_Initialize::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(Results_TopPanel_C_Initialize, K2Node_MakeStruct_FormatArgumentData1) == 0x000440, "Member 'Results_TopPanel_C_Initialize::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
static_assert(offsetof(Results_TopPanel_C_Initialize, K2Node_MakeArray_Array) == 0x000480, "Member 'Results_TopPanel_C_Initialize::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Results_TopPanel_C_Initialize, CallFunc_Format_ReturnValue) == 0x000490, "Member 'Results_TopPanel_C_Initialize::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TopPanel_C_Initialize, Temp_byte_Variable) == 0x0004A8, "Member 'Results_TopPanel_C_Initialize::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(Results_TopPanel_C_Initialize, K2Node_Select_Default) == 0x0004B0, "Member 'Results_TopPanel_C_Initialize::K2Node_Select_Default' has a wrong offset!");
