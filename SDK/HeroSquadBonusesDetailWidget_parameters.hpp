...
static_assert(offsetof(HeroSquadBonusesDetailWidget_C_ExecuteUbergraph_HeroSquadBonusesDetailWidget, Temp_byte_Variable1) == 0x000013, "Member 'HeroSquadBonusesDetailWidget_C_ExecuteUbergraph_HeroSquadBonusesDetailWidget::Temp_byte_Variable1' has a wrong offset!");
