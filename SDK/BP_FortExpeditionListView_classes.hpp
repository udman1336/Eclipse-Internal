...
static_assert(sizeof(UBP_FortExpeditionListView_C) == 0x000278, "Wrong size on UBP_FortExpeditionListView_C");
static_assert(offsetof(UBP_FortExpeditionListView_C, UberGraphFrame) == 0x000250, "Member 'UBP_FortExpeditionListView_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_FortExpeditionListView_C, OnItemClicked) == 0x000258, "Member 'UBP_FortExpeditionListView_C::OnItemClicked' has a wrong offset!");
static_assert(offsetof(UBP_FortExpeditionListView_C, OnItemHovered) == 0x000268, "Member 'UBP_FortExpeditionListView_C::OnItemHovered' has a wrong offset!");
