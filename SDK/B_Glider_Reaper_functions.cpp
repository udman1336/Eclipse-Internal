...
#include "B_Glider_Reaper_classes.hpp"
#include "B_Glider_Reaper_parameters.hpp"
...
void AB_Glider_Reaper_C::ExecuteUbergraph_B_Glider_Reaper(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_Reaper_C", "ExecuteUbergraph_B_Glider_Reaper");

	Params::B_Glider_Reaper_C_ExecuteUbergraph_B_Glider_Reaper Parms{};
...
void AB_Glider_Reaper_C::OnParachuteTrailUpdated(float MovementLengthSquared, float ForwardDot, float RightDot, float RotationalMovementAcceleration)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_Reaper_C", "OnParachuteTrailUpdated");

	Params::B_Glider_Reaper_C_OnParachuteTrailUpdated Parms{};
...
void AB_Glider_Reaper_C::FireDynamics()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_Reaper_C", "FireDynamics");
...
void AB_Glider_Reaper_C::ReceiveBeginPlay()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_Reaper_C", "ReceiveBeginPlay");
...
void AB_Glider_Reaper_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Glider_Reaper_C", "UserConstructionScript");
