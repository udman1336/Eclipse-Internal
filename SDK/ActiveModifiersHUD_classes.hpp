...
static_assert(sizeof(UActiveModifiersHUD_C) == 0x000270, "Wrong size on UActiveModifiersHUD_C");
static_assert(offsetof(UActiveModifiersHUD_C, UberGraphFrame) == 0x000240, "Member 'UActiveModifiersHUD_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UActiveModifiersHUD_C, HboxModifierStack) == 0x000248, "Member 'UActiveModifiersHUD_C::HboxModifierStack' has a wrong offset!");
static_assert(offsetof(UActiveModifiersHUD_C, Timers) == 0x000250, "Member 'UActiveModifiersHUD_C::Timers' has a wrong offset!");
static_assert(offsetof(UActiveModifiersHUD_C, ModifierRows) == 0x000260, "Member 'UActiveModifiersHUD_C::ModifierRows' has a wrong offset!");
