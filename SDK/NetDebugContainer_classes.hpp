...
static_assert(sizeof(UNetDebugContainer_C) == 0x000258, "Wrong size on UNetDebugContainer_C");
static_assert(offsetof(UNetDebugContainer_C, UberGraphFrame) == 0x000240, "Member 'UNetDebugContainer_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UNetDebugContainer_C, InvalidationBox_0) == 0x000248, "Member 'UNetDebugContainer_C::InvalidationBox_0' has a wrong offset!");
static_assert(offsetof(UNetDebugContainer_C, NetDebugUI) == 0x000250, "Member 'UNetDebugContainer_C::NetDebugUI' has a wrong offset!");
