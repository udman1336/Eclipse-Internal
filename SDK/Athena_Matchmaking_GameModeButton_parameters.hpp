...
static_assert(sizeof(Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable) == 0x000048, "Wrong size on Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable");
...
static_assert(offsetof(Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable, CallFunc_GetContext_ReturnValue) == 0x000020, "Member 'Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable, CallFunc_IsPlaylistEnabled_ReturnValue) == 0x000028, "Member 'Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable::CallFunc_IsPlaylistEnabled_ReturnValue' has a wrong offset!");
static_assert(offsetof(Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable, CallFunc_GetActivePlaylists_ReturnValue) == 0x000030, "Member 'Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable::CallFunc_GetActivePlaylists_ReturnValue' has a wrong offset!");
static_assert(offsetof(Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable, CallFunc_GetCurrentPartySize_ReturnValue) == 0x000040, "Member 'Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable::CallFunc_GetCurrentPartySize_ReturnValue' has a wrong offset!");
static_assert(offsetof(Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable, CallFunc_Array_Contains_ReturnValue) == 0x000044, "Member 'Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000045, "Member 'Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable, CallFunc_BooleanAND_ReturnValue) == 0x000046, "Member 'Athena_Matchmaking_GameModeButton_C_IsGameModeAvailable::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
