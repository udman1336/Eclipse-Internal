...
static_assert(sizeof(ATracer_Shotgun_C) == 0x0003D8, "Wrong size on ATracer_Shotgun_C");
static_assert(offsetof(ATracer_Shotgun_C, UberGraphFrame) == 0x0003D0, "Member 'ATracer_Shotgun_C::UberGraphFrame' has a wrong offset!");
