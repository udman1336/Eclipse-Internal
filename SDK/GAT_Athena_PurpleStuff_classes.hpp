...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GAT_Athena_PurpleStuff_C;           // 0x0B00(0x0008)(Transient, DuplicateTransient)
...
static_assert(sizeof(UGAT_Athena_PurpleStuff_C) == 0x000B10, "Wrong size on UGAT_Athena_PurpleStuff_C");
static_assert(offsetof(UGAT_Athena_PurpleStuff_C, UberGraphFrame_GAT_Athena_PurpleStuff_C) == 0x000B00, "Member 'UGAT_Athena_PurpleStuff_C::UberGraphFrame_GAT_Athena_PurpleStuff_C' has a wrong offset!");
static_assert(offsetof(UGAT_Athena_PurpleStuff_C, PlayerPawn) == 0x000B08, "Member 'UGAT_Athena_PurpleStuff_C::PlayerPawn' has a wrong offset!");
