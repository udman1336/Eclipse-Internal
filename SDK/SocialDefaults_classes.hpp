...
static_assert(sizeof(USocialChatMarkupStyleDataAsset) == 0x000640, "Wrong size on USocialChatMarkupStyleDataAsset");
...
static_assert(sizeof(USocialStyleDataAsset) == 0x006870, "Wrong size on USocialStyleDataAsset");
