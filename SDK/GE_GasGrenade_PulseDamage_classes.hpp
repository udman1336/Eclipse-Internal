...
static_assert(alignof(UGE_GasGrenade_PulseDamage_C) == 0x000010, "Wrong alignment on UGE_GasGrenade_PulseDamage_C");
static_assert(sizeof(UGE_GasGrenade_PulseDamage_C) == 0x000670, "Wrong size on UGE_GasGrenade_PulseDamage_C");
