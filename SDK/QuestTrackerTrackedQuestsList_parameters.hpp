...
static_assert(offsetof(QuestTrackerTrackedQuestsList_C_GetQuestsToDisplay, CallFunc_IsValid_ReturnValue1) == 0x000038, "Member 'QuestTrackerTrackedQuestsList_C_GetQuestsToDisplay::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
