...
static_assert(alignof(UGET_DirectCreatureDamage_C) == 0x000010, "Wrong alignment on UGET_DirectCreatureDamage_C");
static_assert(sizeof(UGET_DirectCreatureDamage_C) == 0x000670, "Wrong size on UGET_DirectCreatureDamage_C");
