...
static_assert(sizeof(UBP_FortExpeditionExpiresWidget_C) == 0x000240, "Wrong size on UBP_FortExpeditionExpiresWidget_C");
static_assert(offsetof(UBP_FortExpeditionExpiresWidget_C, UberGraphFrame) == 0x000228, "Member 'UBP_FortExpeditionExpiresWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_FortExpeditionExpiresWidget_C, ExpeditionExpires) == 0x000230, "Member 'UBP_FortExpeditionExpiresWidget_C::ExpeditionExpires' has a wrong offset!");
static_assert(offsetof(UBP_FortExpeditionExpiresWidget_C, Style) == 0x000238, "Member 'UBP_FortExpeditionExpiresWidget_C::Style' has a wrong offset!");
