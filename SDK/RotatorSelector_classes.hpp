...
static_assert(sizeof(URotatorSelector_C) == 0x000278, "Wrong size on URotatorSelector_C");
static_assert(offsetof(URotatorSelector_C, UberGraphFrame) == 0x000218, "Member 'URotatorSelector_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, ButtonLeft) == 0x000220, "Member 'URotatorSelector_C::ButtonLeft' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, ButtonRight) == 0x000228, "Member 'URotatorSelector_C::ButtonRight' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, DisplayText) == 0x000230, "Member 'URotatorSelector_C::DisplayText' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, TextRotator) == 0x000238, "Member 'URotatorSelector_C::TextRotator' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, SelectedIndex) == 0x000240, "Member 'URotatorSelector_C::SelectedIndex' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, HoverText) == 0x000248, "Member 'URotatorSelector_C::HoverText' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, Selection_Changed) == 0x000260, "Member 'URotatorSelector_C::Selection_Changed' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, Tab_Tooltip_Text) == 0x000270, "Member 'URotatorSelector_C::Tab_Tooltip_Text' has a wrong offset!");
