...
static_assert(sizeof(FAnimNode_AnimDynamics) == 0x000360, "Wrong size on FAnimNode_AnimDynamics");
...
static_assert(offsetof(FAnimNode_AnimDynamics, bLinearSpring) == 0x000164, "Member 'FAnimNode_AnimDynamics::bLinearSpring' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bAngularSpring) == 0x000165, "Member 'FAnimNode_AnimDynamics::bAngularSpring' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, LinearSpringConstant) == 0x000168, "Member 'FAnimNode_AnimDynamics::LinearSpringConstant' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, AngularSpringConstant) == 0x00016C, "Member 'FAnimNode_AnimDynamics::AngularSpringConstant' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bEnableWind) == 0x000170, "Member 'FAnimNode_AnimDynamics::bEnableWind' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bWindWasEnabled) == 0x000171, "Member 'FAnimNode_AnimDynamics::bWindWasEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, WindScale) == 0x000174, "Member 'FAnimNode_AnimDynamics::WindScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bOverrideLinearDamping) == 0x000178, "Member 'FAnimNode_AnimDynamics::bOverrideLinearDamping' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, LinearDampingOverride) == 0x00017C, "Member 'FAnimNode_AnimDynamics::LinearDampingOverride' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bOverrideAngularDamping) == 0x000180, "Member 'FAnimNode_AnimDynamics::bOverrideAngularDamping' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, AngularDampingOverride) == 0x000184, "Member 'FAnimNode_AnimDynamics::AngularDampingOverride' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bOverrideAngularBias) == 0x000188, "Member 'FAnimNode_AnimDynamics::bOverrideAngularBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, AngularBiasOverride) == 0x00018C, "Member 'FAnimNode_AnimDynamics::AngularBiasOverride' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bDoUpdate) == 0x000190, "Member 'FAnimNode_AnimDynamics::bDoUpdate' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bDoEval) == 0x000191, "Member 'FAnimNode_AnimDynamics::bDoEval' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, NumSolverIterationsPreUpdate) == 0x000194, "Member 'FAnimNode_AnimDynamics::NumSolverIterationsPreUpdate' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, NumSolverIterationsPostUpdate) == 0x000198, "Member 'FAnimNode_AnimDynamics::NumSolverIterationsPostUpdate' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ConstraintSetup) == 0x00019C, "Member 'FAnimNode_AnimDynamics::ConstraintSetup' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bUsePlanarLimit) == 0x0001F8, "Member 'FAnimNode_AnimDynamics::bUsePlanarLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, PlanarLimits) == 0x000200, "Member 'FAnimNode_AnimDynamics::PlanarLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bUseSphericalLimits) == 0x000210, "Member 'FAnimNode_AnimDynamics::bUseSphericalLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, SphericalLimits) == 0x000218, "Member 'FAnimNode_AnimDynamics::SphericalLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, CollisionType) == 0x000228, "Member 'FAnimNode_AnimDynamics::CollisionType' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, SphereCollisionRadius) == 0x00022C, "Member 'FAnimNode_AnimDynamics::SphereCollisionRadius' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ExternalForce) == 0x000230, "Member 'FAnimNode_AnimDynamics::ExternalForce' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_Trail) == 0x000230, "Wrong size on FAnimNode_Trail");
...
static_assert(offsetof(FAnimNode_Trail, bInvertChainBoneAxis) == 0x00010D, "Member 'FAnimNode_Trail::bInvertChainBoneAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, TrailRelaxation) == 0x000110, "Member 'FAnimNode_Trail::TrailRelaxation' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_Trail, bLimitStretch) == 0x000190, "Member 'FAnimNode_Trail::bLimitStretch' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, StretchLimit) == 0x000194, "Member 'FAnimNode_Trail::StretchLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, FakeVelocity) == 0x000198, "Member 'FAnimNode_Trail::FakeVelocity' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, bActorSpaceFakeVel) == 0x0001A4, "Member 'FAnimNode_Trail::bActorSpaceFakeVel' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, BaseJoint) == 0x0001A8, "Member 'FAnimNode_Trail::BaseJoint' has a wrong offset!");
