...
static_assert(offsetof(BP_FortExpeditionBuildSquadWidget_C_Get_Purchase_Slot_State, CallFunc_GetCurrentInputType_ReturnValue) == 0x000010, "Member 'BP_FortExpeditionBuildSquadWidget_C_Get_Purchase_Slot_State::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_FortExpeditionBuildSquadWidget_C_Get_Purchase_Slot_State, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000012, "Member 'BP_FortExpeditionBuildSquadWidget_C_Get_Purchase_Slot_State::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionBuildSquadWidget_C_Get_Purchase_Slot_State, CallFunc_Not_PreBool_ReturnValue) == 0x000013, "Member 'BP_FortExpeditionBuildSquadWidget_C_Get_Purchase_Slot_State::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
