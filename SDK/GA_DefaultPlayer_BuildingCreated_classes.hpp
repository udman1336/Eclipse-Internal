...
static_assert(sizeof(UGA_DefaultPlayer_BuildingCreated_C) == 0x000AF8, "Wrong size on UGA_DefaultPlayer_BuildingCreated_C");
static_assert(offsetof(UGA_DefaultPlayer_BuildingCreated_C, UberGraphFrame) == 0x000AF0, "Member 'UGA_DefaultPlayer_BuildingCreated_C::UberGraphFrame' has a wrong offset!");
