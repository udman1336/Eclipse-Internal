...
static_assert(offsetof(CollectionBookSectionTileRewardWidget_C_ExecuteUbergraph_CollectionBookSectionTileRewardWidget, Temp_byte_Variable1) == 0x000010, "Member 'CollectionBookSectionTileRewardWidget_C_ExecuteUbergraph_CollectionBookSectionTileRewardWidget::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(CollectionBookSectionTileRewardWidget_C_ExecuteUbergraph_CollectionBookSectionTileRewardWidget, K2Node_Select1_Default) == 0x000020, "Member 'CollectionBookSectionTileRewardWidget_C_ExecuteUbergraph_CollectionBookSectionTileRewardWidget::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(CollectionBookSectionTileRewardWidget_C_SetSlotCompletionRatio, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x00000C, "Member 'CollectionBookSectionTileRewardWidget_C_SetSlotCompletionRatio::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
