...
static_assert(sizeof(UErrorWindow_C) == 0x000478, "Wrong size on UErrorWindow_C");
static_assert(offsetof(UErrorWindow_C, UberGraphFrame) == 0x000410, "Member 'UErrorWindow_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UErrorWindow_C, CloseButton) == 0x000418, "Member 'UErrorWindow_C::CloseButton' has a wrong offset!");
static_assert(offsetof(UErrorWindow_C, Image_0) == 0x000420, "Member 'UErrorWindow_C::Image_0' has a wrong offset!");
static_assert(offsetof(UErrorWindow_C, Lightbox) == 0x000428, "Member 'UErrorWindow_C::Lightbox' has a wrong offset!");
static_assert(offsetof(UErrorWindow_C, LogoutButton) == 0x000430, "Member 'UErrorWindow_C::LogoutButton' has a wrong offset!");
static_assert(offsetof(UErrorWindow_C, MessageList) == 0x000438, "Member 'UErrorWindow_C::MessageList' has a wrong offset!");
static_assert(offsetof(UErrorWindow_C, Title) == 0x000440, "Member 'UErrorWindow_C::Title' has a wrong offset!");
