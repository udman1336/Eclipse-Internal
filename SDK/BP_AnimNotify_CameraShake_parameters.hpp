...
static_assert(offsetof(BP_AnimNotify_CameraShake_C_Received_Notify, K2Node_DynamicCast_bSuccess1) == 0x000040, "Member 'BP_AnimNotify_CameraShake_C_Received_Notify::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
