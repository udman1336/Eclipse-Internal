...
static_assert(sizeof(AlterationWidget_C_InitIcon) == 0x000120, "Wrong size on AlterationWidget_C_InitIcon");
...
static_assert(offsetof(AlterationWidget_C_InitIcon, CallFunc_GetAlterationDefintion_ReturnValue) == 0x000088, "Member 'AlterationWidget_C_InitIcon::CallFunc_GetAlterationDefintion_ReturnValue' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitIcon, CallFunc_IsValid_ReturnValue) == 0x000090, "Member 'AlterationWidget_C_InitIcon::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitIcon, CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue) == 0x000098, "Member 'AlterationWidget_C_InitIcon::CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue' has a wrong offset!");
