...
static_assert(sizeof(ItemTransformItemPicker_C_RemoveInvalidItems) == 0x000090, "Wrong size on ItemTransformItemPicker_C_RemoveInvalidItems");
...
static_assert(offsetof(ItemTransformItemPicker_C_RemoveInvalidItems, CallFunc_CanRecycle_OutRestrictionReasons) == 0x000078, "Member 'ItemTransformItemPicker_C_RemoveInvalidItems::CallFunc_CanRecycle_OutRestrictionReasons' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_RemoveInvalidItems, CallFunc_CanRecycle_ReturnValue) == 0x000088, "Member 'ItemTransformItemPicker_C_RemoveInvalidItems::CallFunc_CanRecycle_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_RemoveInvalidItems, CallFunc_BooleanAND_ReturnValue) == 0x000089, "Member 'ItemTransformItemPicker_C_RemoveInvalidItems::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_RemoveInvalidItems, CallFunc_BooleanAND_ReturnValue1) == 0x00008A, "Member 'ItemTransformItemPicker_C_RemoveInvalidItems::CallFunc_BooleanAND_ReturnValue1' has a wrong offset!");
...
static_assert(sizeof(ItemTransformItemPicker_C_SetupFilterTabList) == 0x0000D8, "Wrong size on ItemTransformItemPicker_C_SetupFilterTabList");
...
static_assert(offsetof(ItemTransformItemPicker_C_SetupFilterTabList, CallFunc_Array_Length_ReturnValue) == 0x0000D0, "Member 'ItemTransformItemPicker_C_SetupFilterTabList::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetupFilterTabList, CallFunc_Less_IntInt_ReturnValue) == 0x0000D4, "Member 'ItemTransformItemPicker_C_SetupFilterTabList::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetupFilterTabList, CallFunc_RegisterFortTab_ReturnValue) == 0x0000D5, "Member 'ItemTransformItemPicker_C_SetupFilterTabList::CallFunc_RegisterFortTab_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(ItemTransformItemPicker_C_SetFilter) == 0x000108, "Wrong size on ItemTransformItemPicker_C_SetFilter");
...
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, LastSelectedIndex) == 0x000008, "Member 'ItemTransformItemPicker_C_SetFilter::LastSelectedIndex' has a wrong offset!");
...
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, Temp_bool_True_if_break_was_hit_Variable) == 0x000010, "Member 'ItemTransformItemPicker_C_SetFilter::Temp_bool_True_if_break_was_hit_Variable' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_Not_PreBool_ReturnValue) == 0x000011, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_GetSelectedItem_ReturnValue) == 0x000018, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_GetSelectedItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_GetIndexForItem_ReturnValue) == 0x000020, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_GetIndexForItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_GetNumItems_ReturnValue) == 0x000024, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_GetNumItems_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_Subtract_IntInt_ReturnValue) == 0x000028, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_Clamp_ReturnValue) == 0x00002C, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_Clamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_SetSelectedIndex_ReturnValue) == 0x000030, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_SetSelectedIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, Temp_int_Loop_Counter_Variable) == 0x000034, "Member 'ItemTransformItemPicker_C_SetFilter::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_Add_IntInt_ReturnValue) == 0x000038, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_Array_Length_ReturnValue) == 0x00003C, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_Array_Get_Item) == 0x000040, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_Less_IntInt_ReturnValue) == 0x000100, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_BooleanAND_ReturnValue) == 0x000101, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformItemPicker_C_SetFilter, CallFunc_EqualEqual_NameName_ReturnValue) == 0x000102, "Member 'ItemTransformItemPicker_C_SetFilter::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
