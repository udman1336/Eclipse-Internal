...
static_assert(sizeof(UCollectionBookRewardCardWidget_C) == 0x0002C0, "Wrong size on UCollectionBookRewardCardWidget_C");
static_assert(offsetof(UCollectionBookRewardCardWidget_C, UberGraphFrame) == 0x000298, "Member 'UCollectionBookRewardCardWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UCollectionBookRewardCardWidget_C, Image_0) == 0x0002A0, "Member 'UCollectionBookRewardCardWidget_C::Image_0' has a wrong offset!");
static_assert(offsetof(UCollectionBookRewardCardWidget_C, Image_1) == 0x0002A8, "Member 'UCollectionBookRewardCardWidget_C::Image_1' has a wrong offset!");
static_assert(offsetof(UCollectionBookRewardCardWidget_C, Image_2) == 0x0002B0, "Member 'UCollectionBookRewardCardWidget_C::Image_2' has a wrong offset!");
static_assert(offsetof(UCollectionBookRewardCardWidget_C, Image_7) == 0x0002B8, "Member 'UCollectionBookRewardCardWidget_C::Image_7' has a wrong offset!");
