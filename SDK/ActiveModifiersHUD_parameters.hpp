...
static_assert(offsetof(ActiveModifiersHUD_C_PopulateModifiers, CallFunc_Less_IntInt_ReturnValue) == 0x0000F0, "Member 'ActiveModifiersHUD_C_PopulateModifiers::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ActiveModifiersHUD_C_PopulateModifiers, CallFunc_AddChildToHorizontalBox_ReturnValue) == 0x0000F8, "Member 'ActiveModifiersHUD_C_PopulateModifiers::CallFunc_AddChildToHorizontalBox_ReturnValue' has a wrong offset!");
