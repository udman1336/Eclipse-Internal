...
static_assert(sizeof(UItemManagementTileButtonStyle_ComparisonModeItemToCompare_C) == 0x0004F0, "Wrong size on UItemManagementTileButtonStyle_ComparisonModeItemToCompare_C");
