...
static_assert(sizeof(EquippedItemWidget_C_FullUpdateResourceDisplay) == 0x0000B8, "Wrong size on EquippedItemWidget_C_FullUpdateResourceDisplay");
...
static_assert(offsetof(EquippedItemWidget_C_FullUpdateResourceDisplay, CallFunc_Conv_IntToText_ReturnValue) == 0x0000A0, "Member 'EquippedItemWidget_C_FullUpdateResourceDisplay::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(EquippedItemWidget_C_UpdateCurrentAmmo, CallFunc_IsValid_ReturnValue) == 0x000080, "Member 'EquippedItemWidget_C_UpdateCurrentAmmo::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(EquippedItemWidget_C_UpdateCurrentAmmo, CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue) == 0x000088, "Member 'EquippedItemWidget_C_UpdateCurrentAmmo::CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue' has a wrong offset!");
static_assert(offsetof(EquippedItemWidget_C_UpdateCurrentAmmo, Temp_bool_Variable) == 0x000110, "Member 'EquippedItemWidget_C_UpdateCurrentAmmo::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(EquippedItemWidget_C_UpdateCurrentAmmo, Temp_float_Variable) == 0x000114, "Member 'EquippedItemWidget_C_UpdateCurrentAmmo::Temp_float_Variable' has a wrong offset!");
