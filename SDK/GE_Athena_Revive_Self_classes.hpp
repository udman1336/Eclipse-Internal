...
static_assert(alignof(UGE_Athena_Revive_Self_C) == 0x000010, "Wrong alignment on UGE_Athena_Revive_Self_C");
static_assert(sizeof(UGE_Athena_Revive_Self_C) == 0x000670, "Wrong size on UGE_Athena_Revive_Self_C");
