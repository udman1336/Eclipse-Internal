...
static_assert(sizeof(UItemManagementModeDetailsPanel_C) == 0x000250, "Wrong size on UItemManagementModeDetailsPanel_C");
static_assert(offsetof(UItemManagementModeDetailsPanel_C, UberGraphFrame) == 0x000248, "Member 'UItemManagementModeDetailsPanel_C::UberGraphFrame' has a wrong offset!");
