...
static_assert(sizeof(FCatalogOffer) == 0x000218, "Wrong size on FCatalogOffer");
...
static_assert(offsetof(FCatalogOffer, Refundable) == 0x000200, "Member 'FCatalogOffer::Refundable' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, DenyItemTemplateIds) == 0x000208, "Member 'FCatalogOffer::DenyItemTemplateIds' has a wrong offset!");
