...
static_assert(offsetof(ItemInspectEvolveRarityConfirmation_C_SetEvolutionRestrictions, Temp_byte_Variable1) == 0x000001, "Member 'ItemInspectEvolveRarityConfirmation_C_SetEvolutionRestrictions::Temp_byte_Variable1' has a wrong offset!");
