...
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_ComponentBoundEvent_Button1) == 0x000178, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_ComponentBoundEvent_Button) == 0x000180, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
