...
static_assert(sizeof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification) == 0x000068, "Wrong size on FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification");
...
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, CallFunc_GetPlayerController_ReturnValue) == 0x000008, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::CallFunc_GetPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_CreateDelegate_OutputDelegate) == 0x000010, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_DynamicCast_AsFort_Player_Controller_Spectating) == 0x000020, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_DynamicCast_AsFort_Player_Controller_Spectating' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_DynamicCast_bSuccess) == 0x000028, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_Event_MyGeometry) == 0x00002C, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_Event_InDeltaTime) == 0x000064, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_Event_InDeltaTime' has a wrong offset!");
...
static_assert(sizeof(FortReplayNotification_C_ShowNotification) == 0x000040, "Wrong size on FortReplayNotification_C_ShowNotification");
...
static_assert(offsetof(FortReplayNotification_C_ShowNotification, CallFunc_IsVisibilityNotification_IsVisibilityNotification) == 0x000018, "Member 'FortReplayNotification_C_ShowNotification::CallFunc_IsVisibilityNotification_IsVisibilityNotification' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ShowNotification, CallFunc_GetText_ReturnValue) == 0x000020, "Member 'FortReplayNotification_C_ShowNotification::CallFunc_GetText_ReturnValue' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ShowNotification, CallFunc_IsVisible_ReturnValue) == 0x000038, "Member 'FortReplayNotification_C_ShowNotification::CallFunc_IsVisible_ReturnValue' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ShowNotification, CallFunc_IsVisibilityNotification_IsVisibilityNotification1) == 0x000039, "Member 'FortReplayNotification_C_ShowNotification::CallFunc_IsVisibilityNotification_IsVisibilityNotification1' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ShowNotification, CallFunc_Not_PreBool_ReturnValue) == 0x00003A, "Member 'FortReplayNotification_C_ShowNotification::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ShowNotification, CallFunc_BooleanAND_ReturnValue) == 0x00003B, "Member 'FortReplayNotification_C_ShowNotification::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
