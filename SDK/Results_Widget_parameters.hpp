...
static_assert(sizeof(Results_Widget_C_Initialize_Video) == 0x0003E8, "Wrong size on Results_Widget_C_Initialize_Video");
...
static_assert(offsetof(Results_Widget_C_Initialize_Video, CallFunc_GetCurrentBasicMissionInfo_ReturnValue) == 0x000398, "Member 'Results_Widget_C_Initialize_Video::CallFunc_GetCurrentBasicMissionInfo_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Widget_C_Initialize_Video, K2Node_CreateDelegate_OutputDelegate) == 0x0003A0, "Member 'Results_Widget_C_Initialize_Video::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(Results_Widget_C_Initialize_Video, CallFunc_IsValid_ReturnValue) == 0x0003B0, "Member 'Results_Widget_C_Initialize_Video::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Widget_C_Initialize_Video, CallFunc_GetMediaPlayer_ReturnValue) == 0x0003B8, "Member 'Results_Widget_C_Initialize_Video::CallFunc_GetMediaPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Widget_C_Initialize_Video, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0003C0, "Member 'Results_Widget_C_Initialize_Video::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Widget_C_Initialize_Video, K2Node_CreateDelegate_OutputDelegate1) == 0x0003C8, "Member 'Results_Widget_C_Initialize_Video::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(Results_Widget_C_Initialize_Video, Temp_bool_Variable) == 0x0003D8, "Member 'Results_Widget_C_Initialize_Video::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(Results_Widget_C_Initialize_Video, K2Node_Select_Default) == 0x0003E0, "Member 'Results_Widget_C_Initialize_Video::K2Node_Select_Default' has a wrong offset!");
...
static_assert(sizeof(Results_Widget_C_UseVideos) == 0x0003A0, "Wrong size on Results_Widget_C_UseVideos");
...
static_assert(offsetof(Results_Widget_C_UseVideos, CallFunc_GetCurrentBasicMissionInfo_ReturnValue) == 0x000398, "Member 'Results_Widget_C_UseVideos::CallFunc_GetCurrentBasicMissionInfo_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Widget_C_UseVideos, CallFunc_Not_PreBool_ReturnValue) == 0x000399, "Member 'Results_Widget_C_UseVideos::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(alignof(Results_Widget_C_ShouldDisplayEndOfZoneCinematic) == 0x000008, "Wrong alignment on Results_Widget_C_ShouldDisplayEndOfZoneCinematic");
static_assert(sizeof(Results_Widget_C_ShouldDisplayEndOfZoneCinematic) == 0x000018, "Wrong size on Results_Widget_C_ShouldDisplayEndOfZoneCinematic");
static_assert(offsetof(Results_Widget_C_ShouldDisplayEndOfZoneCinematic, ReturnValue) == 0x000000, "Member 'Results_Widget_C_ShouldDisplayEndOfZoneCinematic::ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Widget_C_ShouldDisplayEndOfZoneCinematic, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'Results_Widget_C_ShouldDisplayEndOfZoneCinematic::CallFunc_GetContext_ReturnValue' has a wrong offset!");
