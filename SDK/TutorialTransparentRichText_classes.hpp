...
static_assert(sizeof(UTutorialTransparentRichText_C) == 0x000240, "Wrong size on UTutorialTransparentRichText_C");
static_assert(offsetof(UTutorialTransparentRichText_C, UberGraphFrame) == 0x000218, "Member 'UTutorialTransparentRichText_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTutorialTransparentRichText_C, FortRichTextBlock_0) == 0x000220, "Member 'UTutorialTransparentRichText_C::FortRichTextBlock_0' has a wrong offset!");
static_assert(offsetof(UTutorialTransparentRichText_C, Text) == 0x000228, "Member 'UTutorialTransparentRichText_C::Text' has a wrong offset!");
