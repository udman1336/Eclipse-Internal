...
static_assert(sizeof(UAdditionalEntriesIndicator_C) == 0x000220, "Wrong size on UAdditionalEntriesIndicator_C");
static_assert(offsetof(UAdditionalEntriesIndicator_C, Image_0) == 0x000218, "Member 'UAdditionalEntriesIndicator_C::Image_0' has a wrong offset!");
