...
static_assert(alignof(UGE_AthenaInVehicle_C) == 0x000010, "Wrong alignment on UGE_AthenaInVehicle_C");
static_assert(sizeof(UGE_AthenaInVehicle_C) == 0x000670, "Wrong size on UGE_AthenaInVehicle_C");
