...
static_assert(sizeof(UAthenaSessionId_C) == 0x000250, "Wrong size on UAthenaSessionId_C");
static_assert(offsetof(UAthenaSessionId_C, UberGraphFrame) == 0x000240, "Member 'UAthenaSessionId_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaSessionId_C, Text) == 0x000248, "Member 'UAthenaSessionId_C::Text' has a wrong offset!");
