...
static_assert(offsetof(SurvivorRescuedCounter_C_ExecuteUbergraph_SurvivorRescuedCounter, CallFunc_GetContext_ReturnValue1) == 0x000048, "Member 'SurvivorRescuedCounter_C_ExecuteUbergraph_SurvivorRescuedCounter::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
