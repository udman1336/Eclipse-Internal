...
static_assert(offsetof(GA_BoostJumpPack_Equip_C_GetGadgetItem, CallFunc_K2_GetInventoryItemWithGuid_ReturnValue) == 0x000030, "Member 'GA_BoostJumpPack_Equip_C_GetGadgetItem::CallFunc_K2_GetInventoryItemWithGuid_ReturnValue' has a wrong offset!");
