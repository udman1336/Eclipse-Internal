...
static_assert(sizeof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner) == 0x000248, "Wrong size on PlayerBanner_C_ExecuteUbergraph_PlayerBanner");
...
static_assert(offsetof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner, CallFunc_IsValid_UniqueNetIdRepl_ReturnValue) == 0x000200, "Member 'PlayerBanner_C_ExecuteUbergraph_PlayerBanner::CallFunc_IsValid_UniqueNetIdRepl_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner, CallFunc_SetBannerImage_Success) == 0x000201, "Member 'PlayerBanner_C_ExecuteUbergraph_PlayerBanner::CallFunc_SetBannerImage_Success' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner, CallFunc_EqualEqual_UniqueNetIdReplUniqueNetIdRepl_ReturnValue) == 0x000202, "Member 'PlayerBanner_C_ExecuteUbergraph_PlayerBanner::CallFunc_EqualEqual_UniqueNetIdReplUniqueNetIdRepl_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner, CallFunc_BooleanAND_ReturnValue) == 0x000203, "Member 'PlayerBanner_C_ExecuteUbergraph_PlayerBanner::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner, K2Node_CustomEvent_NewInfo) == 0x000204, "Member 'PlayerBanner_C_ExecuteUbergraph_PlayerBanner::K2Node_CustomEvent_NewInfo' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner, CallFunc_GetContext_ReturnValue) == 0x000238, "Member 'PlayerBanner_C_ExecuteUbergraph_PlayerBanner::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner, CallFunc_GetSubGame_ReturnValue) == 0x000240, "Member 'PlayerBanner_C_ExecuteUbergraph_PlayerBanner::CallFunc_GetSubGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000241, "Member 'PlayerBanner_C_ExecuteUbergraph_PlayerBanner::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(PlayerBanner_C_OnTeamMemberStateChanged) == 0x0001F8, "Wrong size on PlayerBanner_C_OnTeamMemberStateChanged");
