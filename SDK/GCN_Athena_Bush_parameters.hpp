...
static_assert(offsetof(GCN_Athena_Bush_C_ExecuteUbergraph_GCN_Athena_Bush, CallFunc_Greater_FloatFloat_ReturnValue1) == 0x000039, "Member 'GCN_Athena_Bush_C_ExecuteUbergraph_GCN_Athena_Bush::CallFunc_Greater_FloatFloat_ReturnValue1' has a wrong offset!");
