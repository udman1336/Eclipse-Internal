...
static_assert(sizeof(AAnnounce_HeadshotStreak_5x_C) == 0x000480, "Wrong size on AAnnounce_HeadshotStreak_5x_C");
static_assert(offsetof(AAnnounce_HeadshotStreak_5x_C, UberGraphFrame) == 0x000470, "Member 'AAnnounce_HeadshotStreak_5x_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAnnounce_HeadshotStreak_5x_C, DefaultSceneRoot) == 0x000478, "Member 'AAnnounce_HeadshotStreak_5x_C::DefaultSceneRoot' has a wrong offset!");
