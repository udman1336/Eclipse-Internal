...
static_assert(alignof(UAnimNotify_EnemyDeathFX_Off_C) == 0x000008, "Wrong alignment on UAnimNotify_EnemyDeathFX_Off_C");
static_assert(sizeof(UAnimNotify_EnemyDeathFX_Off_C) == 0x000038, "Wrong size on UAnimNotify_EnemyDeathFX_Off_C");
