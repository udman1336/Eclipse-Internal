...
static_assert(offsetof(B_PlayerHealthDamage_CameraLensEffect_C_ExecuteUbergraph_B_PlayerHealthDamage_CameraLensEffect, CallFunc_Subtract_FloatFloat_ReturnValue1) == 0x000014, "Member 'B_PlayerHealthDamage_CameraLensEffect_C_ExecuteUbergraph_B_PlayerHealthDamage_CameraLensEffect::CallFunc_Subtract_FloatFloat_ReturnValue1' has a wrong offset!");
