...
static_assert(offsetof(UDailyRewardsCurrent_C, ScheduleName) == 0x000260, "Member 'UDailyRewardsCurrent_C::ScheduleName' has a wrong offset!");
static_assert(offsetof(UDailyRewardsCurrent_C, IsClaiming) == 0x000278, "Member 'UDailyRewardsCurrent_C::IsClaiming' has a wrong offset!");
static_assert(offsetof(UDailyRewardsCurrent_C, RarityFlare_MID) == 0x000280, "Member 'UDailyRewardsCurrent_C::RarityFlare_MID' has a wrong offset!");
