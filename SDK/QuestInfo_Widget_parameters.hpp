...
static_assert(sizeof(QuestInfo_Widget_C_PopulateRewards) == 0x0000F8, "Wrong size on QuestInfo_Widget_C_PopulateRewards");
...
static_assert(offsetof(QuestInfo_Widget_C_PopulateRewards, K2Node_DynamicCast_AsFort_Quest_Item) == 0x0000C8, "Member 'QuestInfo_Widget_C_PopulateRewards::K2Node_DynamicCast_AsFort_Quest_Item' has a wrong offset!");
static_assert(offsetof(QuestInfo_Widget_C_PopulateRewards, K2Node_DynamicCast_bSuccess) == 0x0000D0, "Member 'QuestInfo_Widget_C_PopulateRewards::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(QuestInfo_Widget_C_PopulateRewards, CallFunc_GetDisplayName_ReturnValue) == 0x0000D8, "Member 'QuestInfo_Widget_C_PopulateRewards::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestInfo_Widget_C_PopulateRewards, CallFunc_IsValid_ReturnValue) == 0x0000F0, "Member 'QuestInfo_Widget_C_PopulateRewards::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(QuestInfo_Widget_C_SetQuestIcon) == 0x000118, "Wrong size on QuestInfo_Widget_C_SetQuestIcon");
...
static_assert(offsetof(QuestInfo_Widget_C_SetQuestIcon, CallFunc_IsValid_ReturnValue) == 0x000088, "Member 'QuestInfo_Widget_C_SetQuestIcon::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestInfo_Widget_C_SetQuestIcon, K2Node_SetFieldsInStruct_StructOut) == 0x000090, "Member 'QuestInfo_Widget_C_SetQuestIcon::K2Node_SetFieldsInStruct_StructOut' has a wrong offset!");
