...
static_assert(offsetof(AthenaDirectAcquisitionOfferWidget_C_UpdateShortDescription, CallFunc_BooleanOR_ReturnValue) == 0x0000FA, "Member 'AthenaDirectAcquisitionOfferWidget_C_UpdateShortDescription::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
