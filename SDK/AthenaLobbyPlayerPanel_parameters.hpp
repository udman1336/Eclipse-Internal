...
static_assert(sizeof(AthenaLobbyPlayerPanel_C_ExecuteUbergraph_AthenaLobbyPlayerPanel) == 0x000018, "Wrong size on AthenaLobbyPlayerPanel_C_ExecuteUbergraph_AthenaLobbyPlayerPanel");
...
static_assert(offsetof(AthenaLobbyPlayerPanel_C_ExecuteUbergraph_AthenaLobbyPlayerPanel, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'AthenaLobbyPlayerPanel_C_ExecuteUbergraph_AthenaLobbyPlayerPanel::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(sizeof(AthenaLobbyPlayerPanel_C_SetTeamMemberInfo) == 0x0001F8, "Wrong size on AthenaLobbyPlayerPanel_C_SetTeamMemberInfo");
...
static_assert(sizeof(AthenaLobbyPlayerPanel_C_OnTeamMemberStateChanged) == 0x000200, "Wrong size on AthenaLobbyPlayerPanel_C_OnTeamMemberStateChanged");
...
static_assert(offsetof(AthenaLobbyPlayerPanel_C_OnTeamMemberStateChanged, CallFunc_AreUniqueIDsIdentical_ReturnValue) == 0x0001F8, "Member 'AthenaLobbyPlayerPanel_C_OnTeamMemberStateChanged::CallFunc_AreUniqueIDsIdentical_ReturnValue' has a wrong offset!");
