...
static_assert(offsetof(InteractionIndicator_C_ExecuteUbergraph_InteractionIndicator, CallFunc_IsBROnly_ReturnValue) == 0x000004, "Member 'InteractionIndicator_C_ExecuteUbergraph_InteractionIndicator::CallFunc_IsBROnly_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(InteractionIndicator_C_HandleInteractionChanged, CallFunc_IsBROnly_ReturnValue) == 0x00000A, "Member 'InteractionIndicator_C_HandleInteractionChanged::CallFunc_IsBROnly_ReturnValue' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_HandleInteractionChanged, Temp_byte_Variable1) == 0x00000B, "Member 'InteractionIndicator_C_HandleInteractionChanged::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_HandleInteractionChanged, Temp_bool_Variable) == 0x00000C, "Member 'InteractionIndicator_C_HandleInteractionChanged::Temp_bool_Variable' has a wrong offset!");
...
static_assert(offsetof(InteractionIndicator_C_ShowBasicInteractionWidget, Temp_bool_Variable) == 0x000002, "Member 'InteractionIndicator_C_ShowBasicInteractionWidget::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_ShowBasicInteractionWidget, CallFunc_IsBROnly_ReturnValue) == 0x000003, "Member 'InteractionIndicator_C_ShowBasicInteractionWidget::CallFunc_IsBROnly_ReturnValue' has a wrong offset!");
