...
static_assert(sizeof(SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData) == 0x0004F0, "Wrong size on SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData");
...
static_assert(offsetof(SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData, Button) == 0x000408, "Member 'SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData::Button' has a wrong offset!");
static_assert(offsetof(SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData, __WorldContext) == 0x000410, "Member 'SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData::__WorldContext' has a wrong offset!");
static_assert(offsetof(SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData, Temp_class_Variable) == 0x000418, "Member 'SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData::Temp_class_Variable' has a wrong offset!");
static_assert(offsetof(SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData, CallFunc_GetSkillTreeNodeIconSizeByMagnitude_Icon_Size) == 0x000420, "Member 'SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData::CallFunc_GetSkillTreeNodeIconSizeByMagnitude_Icon_Size' has a wrong offset!");
static_assert(offsetof(SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData, K2Node_SwitchEnum_CmpSuccess) == 0x000421, "Member 'SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData, CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue) == 0x000428, "Member 'SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData::CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue' has a wrong offset!");
