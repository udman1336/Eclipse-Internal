...
static_assert(sizeof(ChatWidget_C_UpdateChatUserListIcon) == 0x0000B8, "Wrong size on ChatWidget_C_UpdateChatUserListIcon");
...
static_assert(offsetof(ChatWidget_C_UpdateChatUserListIcon, CallFunc_GetContext_ReturnValue1) == 0x000010, "Member 'ChatWidget_C_UpdateChatUserListIcon::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_UpdateChatUserListIcon, CallFunc_GetCurrentGamepadType_ReturnValue) == 0x000018, "Member 'ChatWidget_C_UpdateChatUserListIcon::CallFunc_GetCurrentGamepadType_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_UpdateChatUserListIcon, CallFunc_GetCurrentInputType_ReturnValue) == 0x000019, "Member 'ChatWidget_C_UpdateChatUserListIcon::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, Temp_byte_Variable1) == 0x000003, "Member 'ChatWidget_C_HandeChatEnteredEvent::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, Temp_bool_Variable) == 0x000004, "Member 'ChatWidget_C_HandeChatEnteredEvent::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, Temp_byte_Variable12) == 0x000005, "Member 'ChatWidget_C_HandeChatEnteredEvent::Temp_byte_Variable12' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, Temp_byte_Variable123) == 0x000006, "Member 'ChatWidget_C_HandeChatEnteredEvent::Temp_byte_Variable123' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, Temp_bool_Variable1) == 0x000028, "Member 'ChatWidget_C_HandeChatEnteredEvent::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, CallFunc_GetContext_ReturnValue12) == 0x000030, "Member 'ChatWidget_C_HandeChatEnteredEvent::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, K2Node_Select_Default) == 0x00003A, "Member 'ChatWidget_C_HandeChatEnteredEvent::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, CallFunc_GetContext_ReturnValue123) == 0x000040, "Member 'ChatWidget_C_HandeChatEnteredEvent::CallFunc_GetContext_ReturnValue123' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, CallFunc_EqualEqual_ByteByte_ReturnValue1) == 0x000049, "Member 'ChatWidget_C_HandeChatEnteredEvent::CallFunc_EqualEqual_ByteByte_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, K2Node_Select1_Default) == 0x00004A, "Member 'ChatWidget_C_HandeChatEnteredEvent::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_InitializeChat, CallFunc_GetContext_ReturnValue12) == 0x000028, "Member 'ChatWidget_C_InitializeChat::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
