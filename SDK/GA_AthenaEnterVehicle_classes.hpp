...
static_assert(sizeof(UGA_AthenaEnterVehicle_C) == 0x000AF8, "Wrong size on UGA_AthenaEnterVehicle_C");
static_assert(offsetof(UGA_AthenaEnterVehicle_C, UberGraphFrame) == 0x000AF0, "Member 'UGA_AthenaEnterVehicle_C::UberGraphFrame' has a wrong offset!");
