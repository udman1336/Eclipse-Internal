...
static_assert(offsetof(UBP_FortExpeditionVehicleTileItemWidget_C, Name_0) == 0x000828, "Member 'UBP_FortExpeditionVehicleTileItemWidget_C::Name_0' has a wrong offset!");
