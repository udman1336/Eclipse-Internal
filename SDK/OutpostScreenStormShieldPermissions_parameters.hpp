...
static_assert(sizeof(OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions) == 0x000250, "Wrong size on OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions");
...
static_assert(offsetof(OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions, K2Node_CustomEvent_PlayerIndex) == 0x000238, "Member 'OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions::K2Node_CustomEvent_PlayerIndex' has a wrong offset!");
static_assert(offsetof(OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions, CallFunc_GetContext_ReturnValue) == 0x000240, "Member 'OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions, CallFunc_GetLocalPlayerTeam_ReturnValue) == 0x000248, "Member 'OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions::CallFunc_GetLocalPlayerTeam_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(OutpostScreenStormShieldPermissions_C_UpdatePrivilagesEvent_0) == 0x0001F8, "Wrong size on OutpostScreenStormShieldPermissions_C_UpdatePrivilagesEvent_0");
