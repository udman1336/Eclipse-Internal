...
static_assert(offsetof(Subtitles_C_GetSubtitleVisibility, Temp_byte_Variable1) == 0x000003, "Member 'Subtitles_C_GetSubtitleVisibility::Temp_byte_Variable1' has a wrong offset!");
