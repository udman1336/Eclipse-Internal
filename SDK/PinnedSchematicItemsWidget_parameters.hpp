...
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, CallFunc_GetChildAt_ReturnValue1) == 0x000080, "Member 'PinnedSchematicItemsWidget_C_Refresh::CallFunc_GetChildAt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, K2Node_DynamicCast_AsPinned_Schematic_Item_Widget1) == 0x000088, "Member 'PinnedSchematicItemsWidget_C_Refresh::K2Node_DynamicCast_AsPinned_Schematic_Item_Widget1' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, K2Node_DynamicCast_bSuccess1) == 0x000090, "Member 'PinnedSchematicItemsWidget_C_Refresh::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
