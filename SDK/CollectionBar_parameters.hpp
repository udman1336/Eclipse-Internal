...
static_assert(sizeof(CollectionBar_C_SetIcon) == 0x000098, "Wrong size on CollectionBar_C_SetIcon");
static_assert(offsetof(CollectionBar_C_SetIcon, InIcon) == 0x000000, "Member 'CollectionBar_C_SetIcon::InIcon' has a wrong offset!");
static_assert(offsetof(CollectionBar_C_SetIcon, K2Node_DynamicCast_AsHorizontal_Box_Slot) == 0x000088, "Member 'CollectionBar_C_SetIcon::K2Node_DynamicCast_AsHorizontal_Box_Slot' has a wrong offset!");
static_assert(offsetof(CollectionBar_C_SetIcon, K2Node_DynamicCast_bSuccess) == 0x000090, "Member 'CollectionBar_C_SetIcon::K2Node_DynamicCast_bSuccess' has a wrong offset!");
