...
static_assert(offsetof(ItemTransformSlotItemPickerTileButton_C_ExecuteUbergraph_ItemTransformSlotItemPickerTileButton, CallFunc_GetTransmogSacrificeDataFromItemDefintion_OutTransmogData) == 0x000038, "Member 'ItemTransformSlotItemPickerTileButton_C_ExecuteUbergraph_ItemTransformSlotItemPickerTileButton::CallFunc_GetTransmogSacrificeDataFromItemDefintion_OutTransmogData' has a wrong offset!");
static_assert(offsetof(ItemTransformSlotItemPickerTileButton_C_ExecuteUbergraph_ItemTransformSlotItemPickerTileButton, CallFunc_GetTransmogSacrificeDataFromItemDefintion_ReturnValue) == 0x000048, "Member 'ItemTransformSlotItemPickerTileButton_C_ExecuteUbergraph_ItemTransformSlotItemPickerTileButton::CallFunc_GetTransmogSacrificeDataFromItemDefintion_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformSlotItemPickerTileButton_C_ExecuteUbergraph_ItemTransformSlotItemPickerTileButton, K2Node_Select_Default) == 0x000050, "Member 'ItemTransformSlotItemPickerTileButton_C_ExecuteUbergraph_ItemTransformSlotItemPickerTileButton::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(ItemTransformSlotItemPickerTileButton_C_ExecuteUbergraph_ItemTransformSlotItemPickerTileButton, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000058, "Member 'ItemTransformSlotItemPickerTileButton_C_ExecuteUbergraph_ItemTransformSlotItemPickerTileButton::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
