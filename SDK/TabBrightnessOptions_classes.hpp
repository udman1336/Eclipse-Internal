...
static_assert(offsetof(UTabBrightnessOptions_C, CommonTextBlock_0) == 0x000270, "Member 'UTabBrightnessOptions_C::CommonTextBlock_0' has a wrong offset!");
static_assert(offsetof(UTabBrightnessOptions_C, DefaultCallOut) == 0x000278, "Member 'UTabBrightnessOptions_C::DefaultCallOut' has a wrong offset!");
static_assert(offsetof(UTabBrightnessOptions_C, Image_0) == 0x000280, "Member 'UTabBrightnessOptions_C::Image_0' has a wrong offset!");
static_assert(offsetof(UTabBrightnessOptions_C, Image_1) == 0x000288, "Member 'UTabBrightnessOptions_C::Image_1' has a wrong offset!");
static_assert(offsetof(UTabBrightnessOptions_C, Image_152) == 0x000290, "Member 'UTabBrightnessOptions_C::Image_152' has a wrong offset!");
static_assert(offsetof(UTabBrightnessOptions_C, OptionsMenuSlider) == 0x000298, "Member 'UTabBrightnessOptions_C::OptionsMenuSlider' has a wrong offset!");
