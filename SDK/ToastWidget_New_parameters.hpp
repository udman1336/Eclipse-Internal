...
static_assert(sizeof(ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New) == 0x000140, "Wrong size on ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New");
...
static_assert(offsetof(ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
