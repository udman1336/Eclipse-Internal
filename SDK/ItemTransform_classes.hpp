...
static_assert(sizeof(UItemTransform_C) == 0x000450, "Wrong size on UItemTransform_C");
...
static_assert(offsetof(UItemTransform_C, BackInputAction) == 0x0003E8, "Member 'UItemTransform_C::BackInputAction' has a wrong offset!");
static_assert(offsetof(UItemTransform_C, SelectKeyInputAction) == 0x0003F8, "Member 'UItemTransform_C::SelectKeyInputAction' has a wrong offset!");
static_assert(offsetof(UItemTransform_C, TransformInputAction) == 0x000408, "Member 'UItemTransform_C::TransformInputAction' has a wrong offset!");
static_assert(offsetof(UItemTransform_C, SelectItemInputAction) == 0x000418, "Member 'UItemTransform_C::SelectItemInputAction' has a wrong offset!");
static_assert(offsetof(UItemTransform_C, InspectItemInputAction) == 0x000428, "Member 'UItemTransform_C::InspectItemInputAction' has a wrong offset!");
static_assert(offsetof(UItemTransform_C, IsItemPickerOpen) == 0x000438, "Member 'UItemTransform_C::IsItemPickerOpen' has a wrong offset!");
static_assert(offsetof(UItemTransform_C, ClosePickerInputAction) == 0x000440, "Member 'UItemTransform_C::ClosePickerInputAction' has a wrong offset!");
