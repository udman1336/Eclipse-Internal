...
static_assert(offsetof(ItemTransformSlotScreen_C_Get_Transform_Data, CallFunc_Get_Transform_Data_CurrentTier) == 0x000024, "Member 'ItemTransformSlotScreen_C_Get_Transform_Data::CallFunc_Get_Transform_Data_CurrentTier' has a wrong offset!");
