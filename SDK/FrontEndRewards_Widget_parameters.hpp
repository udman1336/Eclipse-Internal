...
static_assert(alignof(FrontEndRewards_Widget_C_StartRewardsMusic) == 0x000008, "Wrong alignment on FrontEndRewards_Widget_C_StartRewardsMusic");
static_assert(sizeof(FrontEndRewards_Widget_C_StartRewardsMusic) == 0x000020, "Wrong size on FrontEndRewards_Widget_C_StartRewardsMusic");
static_assert(offsetof(FrontEndRewards_Widget_C_StartRewardsMusic, CallFunc_GetAllActorsOfClass_OutActors) == 0x000000, "Member 'FrontEndRewards_Widget_C_StartRewardsMusic::CallFunc_GetAllActorsOfClass_OutActors' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_StartRewardsMusic, CallFunc_Array_Get_Item) == 0x000010, "Member 'FrontEndRewards_Widget_C_StartRewardsMusic::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_StartRewardsMusic, CallFunc_IsValid_ReturnValue) == 0x000018, "Member 'FrontEndRewards_Widget_C_StartRewardsMusic::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(FrontEndRewards_Widget_C_ShowGiftBox, CallFunc_GetOwningPlayer_ReturnValue) == 0x000000, "Member 'FrontEndRewards_Widget_C_ShowGiftBox::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_ShowGiftBox, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'FrontEndRewards_Widget_C_ShowGiftBox::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_ShowGiftBox, CallFunc_Create_ReturnValue) == 0x000018, "Member 'FrontEndRewards_Widget_C_ShowGiftBox::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_ShowGiftBox, CallFunc_GetGiftBoxDefinition_ReturnValue) == 0x000020, "Member 'FrontEndRewards_Widget_C_ShowGiftBox::CallFunc_GetGiftBoxDefinition_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_ShowGiftBox, CallFunc_GetUIManagerWidget_ReturnValue) == 0x000028, "Member 'FrontEndRewards_Widget_C_ShowGiftBox::CallFunc_GetUIManagerWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_ShowGiftBox, CallFunc_IsValidClass_ReturnValue) == 0x000030, "Member 'FrontEndRewards_Widget_C_ShowGiftBox::CallFunc_IsValidClass_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(FrontEndRewards_Widget_C_ShowGiftBox, K2Node_DynamicCast_AsItem_Received_Pre_Prompt) == 0x000048, "Member 'FrontEndRewards_Widget_C_ShowGiftBox::K2Node_DynamicCast_AsItem_Received_Pre_Prompt' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_ShowGiftBox, K2Node_DynamicCast_bSuccess) == 0x000050, "Member 'FrontEndRewards_Widget_C_ShowGiftBox::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_ShowGiftBox, CallFunc_GetUIManagerWidget_ReturnValue1) == 0x000058, "Member 'FrontEndRewards_Widget_C_ShowGiftBox::CallFunc_GetUIManagerWidget_ReturnValue1' has a wrong offset!");
