...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GAB_Melee_GenericCombo_C;           // 0x0B08(0x0008)(Transient, DuplicateTransient)
	float                                         OriginalMontagePlayRate;                           // 0x0B10(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGAB_Melee_GenericCombo_C) == 0x000B18, "Wrong size on UGAB_Melee_GenericCombo_C");
static_assert(offsetof(UGAB_Melee_GenericCombo_C, UberGraphFrame_GAB_Melee_GenericCombo_C) == 0x000B08, "Member 'UGAB_Melee_GenericCombo_C::UberGraphFrame_GAB_Melee_GenericCombo_C' has a wrong offset!");
static_assert(offsetof(UGAB_Melee_GenericCombo_C, OriginalMontagePlayRate) == 0x000B10, "Member 'UGAB_Melee_GenericCombo_C::OriginalMontagePlayRate' has a wrong offset!");
