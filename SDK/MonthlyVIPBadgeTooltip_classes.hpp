...
static_assert(sizeof(UMonthlyVIPBadgeTooltip_C) == 0x000220, "Wrong size on UMonthlyVIPBadgeTooltip_C");
static_assert(offsetof(UMonthlyVIPBadgeTooltip_C, HBoxBoost) == 0x000218, "Member 'UMonthlyVIPBadgeTooltip_C::HBoxBoost' has a wrong offset!");
