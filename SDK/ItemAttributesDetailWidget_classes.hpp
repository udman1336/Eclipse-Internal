...
static_assert(sizeof(UItemAttributesDetailWidget_C) == 0x000270, "Wrong size on UItemAttributesDetailWidget_C");
static_assert(offsetof(UItemAttributesDetailWidget_C, UberGraphFrame) == 0x000260, "Member 'UItemAttributesDetailWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemAttributesDetailWidget_C, StatsListWidget) == 0x000268, "Member 'UItemAttributesDetailWidget_C::StatsListWidget' has a wrong offset!");
