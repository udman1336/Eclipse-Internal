...
static_assert(sizeof(ThrowingStarTest_C_OnExecute) == 0x0001D8, "Wrong size on ThrowingStarTest_C_OnExecute");
...
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_Distance) == 0x000158, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_Location) == 0x00015C, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_ImpactPoint) == 0x000168, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_Normal) == 0x000174, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_ImpactNormal) == 0x000180, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_PhysMat) == 0x000190, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_PhysMat' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_HitActor) == 0x000198, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_HitActor' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_HitComponent) == 0x0001A0, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_HitComponent' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_HitBoneName) == 0x0001A8, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_HitBoneName' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_HitItem) == 0x0001B0, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_HitItem' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_FaceIndex) == 0x0001B4, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_TraceStart) == 0x0001B8, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_TraceEnd) == 0x0001C4, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_SpawnEmitterAtLocation_ReturnValue) == 0x0001D0, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_SpawnEmitterAtLocation_ReturnValue' has a wrong offset!");
