...
static_assert(sizeof(AAnnounce_BackpackFull_C) == 0x000480, "Wrong size on AAnnounce_BackpackFull_C");
static_assert(offsetof(AAnnounce_BackpackFull_C, UberGraphFrame) == 0x000470, "Member 'AAnnounce_BackpackFull_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAnnounce_BackpackFull_C, DefaultSceneRoot) == 0x000478, "Member 'AAnnounce_BackpackFull_C::DefaultSceneRoot' has a wrong offset!");
