...
static_assert(sizeof(windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons) == 0x000120, "Wrong size on windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons");
...
static_assert(offsetof(windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons, K2Node_Event_MyGeometry) == 0x000004, "Member 'windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons, K2Node_Event_MouseEvent1) == 0x000040, "Member 'windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons::K2Node_Event_MouseEvent1' has a wrong offset!");
static_assert(offsetof(windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons, K2Node_Event_MouseEvent) == 0x0000B0, "Member 'windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons::K2Node_Event_MouseEvent' has a wrong offset!");
