...
static_assert(alignof(UGET_ModifyEdgedDamage_C) == 0x000010, "Wrong alignment on UGET_ModifyEdgedDamage_C");
static_assert(sizeof(UGET_ModifyEdgedDamage_C) == 0x000670, "Wrong size on UGET_ModifyEdgedDamage_C");
