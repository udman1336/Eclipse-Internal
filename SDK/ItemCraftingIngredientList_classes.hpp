...
static_assert(sizeof(UItemCraftingIngredientList_C) == 0x0002B8, "Wrong size on UItemCraftingIngredientList_C");
static_assert(offsetof(UItemCraftingIngredientList_C, UberGraphFrame) == 0x000298, "Member 'UItemCraftingIngredientList_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemCraftingIngredientList_C, IngredientsList) == 0x0002A0, "Member 'UItemCraftingIngredientList_C::IngredientsList' has a wrong offset!");
static_assert(offsetof(UItemCraftingIngredientList_C, ItemRepresented) == 0x0002A8, "Member 'UItemCraftingIngredientList_C::ItemRepresented' has a wrong offset!");
static_assert(offsetof(UItemCraftingIngredientList_C, IconSize) == 0x0002B0, "Member 'UItemCraftingIngredientList_C::IconSize' has a wrong offset!");
