...
static_assert(sizeof(UInfoWindow_C) == 0x000438, "Wrong size on UInfoWindow_C");
static_assert(offsetof(UInfoWindow_C, UberGraphFrame) == 0x000400, "Member 'UInfoWindow_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UInfoWindow_C, CloseButton) == 0x000408, "Member 'UInfoWindow_C::CloseButton' has a wrong offset!");
static_assert(offsetof(UInfoWindow_C, EntryIcon) == 0x000410, "Member 'UInfoWindow_C::EntryIcon' has a wrong offset!");
static_assert(offsetof(UInfoWindow_C, EntryText) == 0x000418, "Member 'UInfoWindow_C::EntryText' has a wrong offset!");
static_assert(offsetof(UInfoWindow_C, Lightbox) == 0x000420, "Member 'UInfoWindow_C::Lightbox' has a wrong offset!");
static_assert(offsetof(UInfoWindow_C, SizeBox_1) == 0x000428, "Member 'UInfoWindow_C::SizeBox_1' has a wrong offset!");
static_assert(offsetof(UInfoWindow_C, Title) == 0x000430, "Member 'UInfoWindow_C::Title' has a wrong offset!");
