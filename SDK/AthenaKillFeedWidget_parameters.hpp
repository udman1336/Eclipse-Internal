...
static_assert(offsetof(AthenaKillFeedWidget_C_UpdateKillFeed, CallFunc_Array_Get_Item1) == 0x000028, "Member 'AthenaKillFeedWidget_C_UpdateKillFeed::CallFunc_Array_Get_Item1' has a wrong offset!");
