...
static_assert(sizeof(MiniPartyMember_C_OnPlayerInfoChanged) == 0x0001F8, "Wrong size on MiniPartyMember_C_OnPlayerInfoChanged");
...
static_assert(sizeof(MiniPartyMember_C_UpdateMemberInfo) == 0x000208, "Wrong size on MiniPartyMember_C_UpdateMemberInfo");
...
static_assert(offsetof(MiniPartyMember_C_UpdateMemberInfo, CallFunc_GetContext_ReturnValue) == 0x0001F8, "Member 'MiniPartyMember_C_UpdateMemberInfo::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(MiniPartyMember_C_UpdateMemberInfo, CallFunc_GetPartyMemberDisplayState_ReturnValue) == 0x000200, "Member 'MiniPartyMember_C_UpdateMemberInfo::CallFunc_GetPartyMemberDisplayState_ReturnValue' has a wrong offset!");
static_assert(offsetof(MiniPartyMember_C_UpdateMemberInfo, K2Node_SwitchEnum_CmpSuccess) == 0x000201, "Member 'MiniPartyMember_C_UpdateMemberInfo::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
