...
static_assert(offsetof(USquadSlotDetailsPanel_C, SlottedItemDetailsSwitcher) == 0x0002A0, "Member 'USquadSlotDetailsPanel_C::SlottedItemDetailsSwitcher' has a wrong offset!");
static_assert(offsetof(USquadSlotDetailsPanel_C, SlottingRestrictionsBox) == 0x0002A8, "Member 'USquadSlotDetailsPanel_C::SlottingRestrictionsBox' has a wrong offset!");
static_assert(offsetof(USquadSlotDetailsPanel_C, SlottingRestrictionsTextBlock) == 0x0002B0, "Member 'USquadSlotDetailsPanel_C::SlottingRestrictionsTextBlock' has a wrong offset!");
static_assert(offsetof(USquadSlotDetailsPanel_C, SquadSlotLabelTextBlock) == 0x0002B8, "Member 'USquadSlotDetailsPanel_C::SquadSlotLabelTextBlock' has a wrong offset!");
static_assert(offsetof(USquadSlotDetailsPanel_C, DisplayName) == 0x0002C0, "Member 'USquadSlotDetailsPanel_C::DisplayName' has a wrong offset!");
static_assert(offsetof(USquadSlotDetailsPanel_C, ItemType) == 0x0002D8, "Member 'USquadSlotDetailsPanel_C::ItemType' has a wrong offset!");
