...
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_Less_IntInt_ReturnValue) == 0x000004, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_Less_IntInt_ReturnValue1) == 0x0000B8, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_Less_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_Subtract_IntInt_ReturnValue1) == 0x0000BC, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_Subtract_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_GetContext_ReturnValue1) == 0x0000C0, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_GetAthenaProfile_ReturnValue1) == 0x0000C8, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_GetAthenaProfile_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x0000D0, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_IsValid_ReturnValue1) == 0x0000D1, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_GetSeasonLevelInfo_ReturnValue1) == 0x0000D8, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_GetSeasonLevelInfo_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_Greater_IntInt_ReturnValue) == 0x0000F8, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
