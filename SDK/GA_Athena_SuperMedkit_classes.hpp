...
static_assert(sizeof(UGA_Athena_SuperMedkit_C) == 0x000B80, "Wrong size on UGA_Athena_SuperMedkit_C");
static_assert(offsetof(UGA_Athena_SuperMedkit_C, UberGraphFrame) == 0x000AF0, "Member 'UGA_Athena_SuperMedkit_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Athena_SuperMedkit_C, AnimMontageInfo) == 0x000AF8, "Member 'UGA_Athena_SuperMedkit_C::AnimMontageInfo' has a wrong offset!");
static_assert(offsetof(UGA_Athena_SuperMedkit_C, SpawnHeading) == 0x000B58, "Member 'UGA_Athena_SuperMedkit_C::SpawnHeading' has a wrong offset!");
static_assert(offsetof(UGA_Athena_SuperMedkit_C, PlayerPawn) == 0x000B68, "Member 'UGA_Athena_SuperMedkit_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_Athena_SuperMedkit_C, Projectile) == 0x000B70, "Member 'UGA_Athena_SuperMedkit_C::Projectile' has a wrong offset!");
static_assert(offsetof(UGA_Athena_SuperMedkit_C, HealingAmount) == 0x000B78, "Member 'UGA_Athena_SuperMedkit_C::HealingAmount' has a wrong offset!");
static_assert(offsetof(UGA_Athena_SuperMedkit_C, TriggerDuration) == 0x000B7C, "Member 'UGA_Athena_SuperMedkit_C::TriggerDuration' has a wrong offset!");
