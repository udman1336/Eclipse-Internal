...
static_assert(offsetof(HUD_PickupItemWidget_C_InitializeItemData, Temp_bool_Variable1) == 0x000011, "Member 'HUD_PickupItemWidget_C_InitializeItemData::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(HUD_PickupItemWidget_C_InitializeItemData, Temp_byte_Variable1) == 0x000013, "Member 'HUD_PickupItemWidget_C_InitializeItemData::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(HUD_PickupItemWidget_C_InitializeItemData, CallFunc_IsValid_ReturnValue1) == 0x000015, "Member 'HUD_PickupItemWidget_C_InitializeItemData::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
static_assert(offsetof(HUD_PickupItemWidget_C_InitializeItemData, K2Node_Select1_Default) == 0x000018, "Member 'HUD_PickupItemWidget_C_InitializeItemData::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(HUD_PickupItemWidget_C_InitializeInteractionFailureText, Temp_byte_Variable1) == 0x000049, "Member 'HUD_PickupItemWidget_C_InitializeInteractionFailureText::Temp_byte_Variable1' has a wrong offset!");
