...
static_assert(offsetof(GA_Trap_WallElectric_C_ExecuteUbergraph_GA_Trap_WallElectric, Temp_struct_Variable1) == 0x000020, "Member 'GA_Trap_WallElectric_C_ExecuteUbergraph_GA_Trap_WallElectric::Temp_struct_Variable1' has a wrong offset!");
